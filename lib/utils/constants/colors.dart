...
class MyColors {
  ...
  static const Color primary =  Color(0xff9f1c34);
  static const Color secondary = Color(0xD7EF9A9A);
  ...
  static const Color edit = Colors.blueGrey;
  static const Color delete = Color(0xFFEF5350);
